...
== The final product
Here's the animated music video I made. Push _play_ to start it.

_To restart the video refresh this page (push F5)._

+++
<iframe src='/assets/apps/2018_09_prime_directive_animation/index.html' width='700px' height='400px'></iframe>
+++

You can download the FL Studio project file to see how the audio was made. FL Studio 20 runs on Apple & Windows and the project can be viewed and played for free (but not saved with the free FL Studio version).

View link:/assets/apps/2018_09_prime_directive_animation/[fullscreen].
...
or
link:++/assets/apps/2018_09_prime_directive_animation/2018-09%20-%20Richard%20JE%20Cooke%20-%20Prime%20Directive%20-%20Version%206.flp++[FL Studio 20 project file].
...
=== Audio
I wrote the audio in https://www.image-line.com/flstudio/[FL Studio] (FLS) as it is an excellent choice for making electronic music fast.
...
I wrote the video in _three.js_. There isn't much to say about this.
I mostly copied and pasted snippets of code from their site's examples until I had what I wanted.

The full code listing is given below.
If you'd like to play with it yourself just save it to an HTML file and drag it into your browser.
You'll need to change the three.js source from local disk to this: `https://cdnjs.cloudflare.com/ajax/libs/three.js/96/three.js` for it to work unless you run a local web server.
